...
public class Controller {
    ...
    public static void main(String[] args) {
        ...
        Operator operator1 = new Operator("operator1", semaphore, resource);
        Operator operator2 = new Operator("operator2", semaphore, resource);
        Operator operator3 = new Operator("operator3", semaphore, resource);
        Operator operator4 = new Operator("operator4", semaphore, resource);
        Operator operator5 = new Operator("operator5", semaphore, resource);
